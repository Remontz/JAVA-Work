package com.kacygilbert.houseHunter.controllers;
...
import com.kacygilbert.houseHunter.services.NoteService;
...
public class ListingController {
	...
	public String viewListing(@PathVariable("id") Long id, Model model, HttpSession session, @ModelAttribute("listing") Listing listing, @ModelAttribute("note") Note note) {
